...
// Define the props for the NewsSection component using the imported type
interface NewsSectionProps {
  newsArticles: NewsArticle[];
  openArticle: (article: NewsArticle) => void;
}

export function NewsSection({ newsArticles, openArticle }: NewsSectionProps) {
  return (
          ...
          {newsArticles.map((news, i) => (
            ...
            >
              ...
              <Button
                ...
                onClick={() => openArticle(news)} // Use the passed-in function
              >
                Read More
              </Button>
            </div>
